...
#Demo
# text_feat = extract_text_features(["a photo of a cat"], tokenizer, model)
# vid_feat = video_loader("/ssd_scratch/cvit/varun/video7017.mp4", processor, model)

# sim = F.cosine_similarity(text_feat, vid_feat, dim=1)
# print(sim)
